package com.imuhao.pictureeveryday.ui.view.swipeback;
...
public class SwipeBackFragment extends Fragment {
	...
	protected SwipeBackActivity mActivity;
	...
	public void onAttach(Context context) {
		...
		if (context instanceof SwipeBackActivity) {
			...
			throw new RuntimeException(context.toString() + " must extends SwipeBackActivity");
		}
	}
	...
	/**
	 * 修正：如果activity中只有一个Fragment的时候不能侧滑
	 *
	 * @param enable
	 */
