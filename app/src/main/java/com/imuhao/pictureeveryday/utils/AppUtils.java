...
public final class AppUtils {
  ...
  public static boolean isServiceRunning(Context context, String className) {
    ...
    for (ActivityManager.RunningServiceInfo si : servicesList) {
      if (className.equals(si.service.getClassName())) isRunning = true;
    }
    return isRunning;
  }
  ...
  public static boolean stopRunningService(Context context, String className) {
    ...
    if (intent_service != null) ret = context.stopService(intent_service);
    return ret;
  }
  ...
  public static boolean isNamedProcess(Context context, String processName) {
    if (context == null || processName == null) return false;
      ...
      try {
        ...
        try {
          ...
          if ("libdvm.so".equals(value)) {
            ...
            return "ART";
          } else if ("libartd.so".equals(value)) return "ART debug build";
          return value;
