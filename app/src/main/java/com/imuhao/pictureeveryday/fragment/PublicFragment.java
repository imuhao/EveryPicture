package com.imuhao.pictureeveryday.fragment;
...
import com.imuhao.pictureeveryday.activity.WebActivity;
import com.imuhao.pictureeveryday.adapter.PublicAdapter;
import com.imuhao.pictureeveryday.base.BaseFragment;
...
import com.imuhao.pictureeveryday.listener.OnRcvScrollListener;
import com.imuhao.pictureeveryday.listener.onItemClickListener;
import com.imuhao.pictureeveryday.listener.onScrollBottomListener;
 ...
 * @desc ${TODD}
 */
public class PublicFragment extends BaseFragment implements onItemClickListener, onScrollBottomListener {
    ...
    private MyCallBack mMyCallBack = new MyCallBack<List<EssayBean>>() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_public_category, null);
        initView(view);
        return view;
    }
    ...
    private void initView(View view) {
        ...
        SmileApi.getEssatData(flagFragment, 0x001, count, index, mMyCallBack);
        loadingData = true;
    }
