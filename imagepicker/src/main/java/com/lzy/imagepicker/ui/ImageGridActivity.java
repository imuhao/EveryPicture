...
public class ImageGridActivity extends ImageBaseActivity implements ImageDataSource.OnImagesLoadedListener, ImageGridAdapter.OnImageItemClickListener, ImagePicker.OnImageSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null && intent.hasExtra("data")) {
            ArrayList<ImageItem> selectedImages = (ArrayList<ImageItem>) intent.getSerializableExtra("data");
            mImageGridAdapter.setSelectedImages(selectedImages);
        }
        // 自动拍照
        if (intent != null && intent.hasExtra("autotakephoto")) {
            if (intent.getBooleanExtra("autotakephoto", false)) {
