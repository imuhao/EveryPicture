...
public class SideBar extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		for (int i = 0; i < b.length; i++) {
			...
			paint.setTextSize(DensityUtil.dp2px(getContext(), 14));
			// x坐标等于中间-字符串宽度的一半.
			...
			//			if(b[i].equals("☆")){
			//				paint.setTextSize(DensityUtil.dp2px(getContext(),14));
			//				xPos+=DensityUtil.dp2px(getContext(),1);
			//				yPos-=DensityUtil.dp2px(getContext(),1);
			//			}
	...
	/*public void setOnTouchingLetterChangedListener(FriendListActivity friendListActivity) {
	}*/
